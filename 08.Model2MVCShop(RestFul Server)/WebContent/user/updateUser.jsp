...
function fncUpdateUser() {
	...
	if(document.detailForm.phone2.value != "" && document.detailForm.phone2.value != "") {
		...
		document.detailForm.phone2.value + "-" + document.detailForm.phone3.value;
	} else {
	...
	<tr>
		...
		<td background="/images/ct_ttl_img02.gif" width="100%" style="padding-left:10px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="93%" class="ct_ttl01">회원 정보 수정</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input	type="file" name="photo" class="ct_input_g" 
						style="width: 200px; height: 19px" maxLength="13" value="${user.photo}"/>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		<td width="104" class="ct_write">가입일</td>
		<td bgcolor="D6D6D6" width="1"></td>
