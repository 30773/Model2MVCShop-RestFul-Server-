...
<form name="detailForm" action="/purchase/getPurchase?tran_no=${purchase.tranNo}" method="post">
	...
	<tr>
		...
		<td background="/images/ct_ttl_img02.gif" width="100%" style="padding-left: 10px;">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="93%" class="ct_ttl01">구매 상세 조회</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		<td width="104" class="ct_write">
			물품 번호 <img src="/images/ct_icon_red.gif" width="3" height="3" align="absmiddle"/>
		</td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<c:if test="${purchase.paymentOption.trim() eq '1'}">현금구매</c:if>
			<c:if test="${purchase.paymentOption.trim() eq '2'}">신용구매</c:if>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		<td width="104" class="ct_write">구매자 전화번호</td>
		<td bgcolor="D6D6D6" width="1"></td>
	...
	<tr>
		<td width="104" class="ct_write">요청사항(구매)</td>
		<td bgcolor="D6D6D6" width="1"></td>
